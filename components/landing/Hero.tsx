...
export const Hero = () => {
  return (
    <section id="home" className="pt-36 pb-10 px-4 sm:px-6 lg:px-8 min-h-screen 
    ">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-8 z-30">
        ...
        <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl">
          Professional language training for students online. Learn A1 to B2 levels with personalized guidance from me.
        </p>

        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-4">
          <button className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition flex items-center justify-center shadow-lg hover:shadow-xl">
            Start Learning
            <ChevronRight className="ml-2 h-5 w-5" />
          </button>

          <a href="https://wa.me/+4915221553164" target="_blank" rel="noopener noreferrer">
  ...
  <div
    className="absolute inset-0 -z-50
               ...
               [background-image:linear-gradient(-45deg,#f5f5ff,#f5f5ff_50%,#dbe0ff_50%,#dbe0ff)]
