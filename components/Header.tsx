...
export const Header = () => {
  ...
  return (
    <motion.header initial={{y: -70}} animate={{y:0}} transition={{duration: 0.3, ease: "easeIn"}} className="fixed w-full z-50 backdrop-blur-md bg-white/30 shadow-md">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <motion.div initial={{y: -200, opacity: 0}} animate={{y:0, opacity: 1}}  transition={{duration: 0.4, ease: "easeIn"}} className="md:hidden bg-white/80  shadow-md">
